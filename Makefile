...
define Build/Compile
	cd $(PKG_BUILD_DIR); $(GO_PKG_VARS) $(USE_GOPROXY) go build -o $(PKG_INSTALL_DIR)/bin/sing-box -trimpath -tags with_quic,with_ech,with_utls -ldflags "-s -w -buildid=" ./cmd/sing-box; 
